...
// 접근제한자 public : 같은 프로젝트 내에서 어떤 클래스에서든 import 할 수 있음을 나타냄.
	...
	// 필드(field) : 객체에 속성을 작성하는 클래스 내부 영역
	// == 멤버 변수 : 메서드 밖에 작성된 변수
	...
	private String name; // 캡슐화 원칙 private - > 간접접근 방법
	...
	//getter / setter	//접근 가능해야 하기 때문에 public 써야함
	public String getName() {
		return name;		// void가 없으면 값을 return해줄게 있다는 뜻
	}
	...
	public Student() {
		// 객체가 생성될 때 수행할 코드
		System.out.println("기본 생성자의 의해 Student 객체가 생성됨");
